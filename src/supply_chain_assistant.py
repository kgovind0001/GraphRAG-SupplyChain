...
from src.models.models import SupplierCountInput, SupplierListInput
from src.tools.supply_count import run_supplier_count_query
from src.tools.supply_list import run_supplier_list_query


class SupplyChainAssistant:
    def __init__(self, nodes_csv="sample_data/nodes.csv", relationships_csv="sample_data/relationships.csv"):
        load_dotenv()
